...
export default function AbmTechStack() {
  return (
    ...
    >
      ...
      <p>For an editorial breakdown of specific tools by category — what each one does, what it is best for, pros, cons, and alternatives — browse the <Link to="/abm-ops/tools">ABM tool library</Link>. It is organized by the job each tool does in your stack, including <Link to="/abm-ops/tools/email-automation">email automation</Link>, <Link to="/abm-ops/tools/linkedin-automation">LinkedIn automation</Link>, <Link to="/abm-ops/tools/lead-sourcing">lead sourcing and data</Link>, <Link to="/abm-ops/tools/intent-data">intent data</Link>, and <Link to="/abm-ops/tools/abm-platforms">ABM platforms</Link>.</p>
